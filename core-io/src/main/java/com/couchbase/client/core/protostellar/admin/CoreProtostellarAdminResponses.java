...
import com.couchbase.client.core.api.admin.CoreAdminCollectionResult;
import com.couchbase.client.core.api.admin.CoreAdminResponseMetadata;
 ...
 */
@Stability.Internal
public class CoreProtostellarAdminResponses {
	private CoreProtostellarAdminResponses() {}

	public static void convertResponse(String bucketName, String scopeName, String collectionName,
			ListenableFuture<CreateCollectionResponse> response) {
		 new CoreAdminCollectionResult(CoreAdminResponseMetadata.NONE, bucketName, scopeName, collectionName);
	}

	public static void convertResponse(String bucketName, String scopeName, String collectionName, CreateCollectionResponse response) {
		 new CoreAdminCollectionResult(CoreAdminResponseMetadata.NONE, bucketName, scopeName, collectionName);
	}

	public static void convertResponse(String bucketName, String scopeName, String collectionName, CreateScopeResponse response) {
		new CoreAdminCollectionResult(CoreAdminResponseMetadata.NONE, bucketName, scopeName, collectionName);
	}

	public static void convertResponse(String bucketName, String scopeName, String collectionName, DeleteScopeResponse response) {
		new CoreAdminCollectionResult(CoreAdminResponseMetadata.NONE, bucketName, scopeName, collectionName);
	}

	public static void convertResponse(String bucketName, String scopeName, String collectionName, DeleteCollectionResponse response) {
		 new CoreAdminCollectionResult(CoreAdminResponseMetadata.NONE, bucketName, scopeName, collectionName);
	}

	public static CollectionsManifest convertResponse(String bucketName, String scopeName, String collectionName, ListCollectionsResponse response) {
