 ...
 */
@Stability.Internal
public class CoreTransactionAttemptContextClassic extends CoreTransactionAttemptContext {
...
//    private final SpanWrapper attemptSpan;
    ...
    public CoreTransactionAttemptContextClassic(Core core, CoreTransactionContext overall, CoreMergedTransactionConfig config, String attemptId,
...
//        this.parent = Objects.requireNonNull(parent);
    ...
    protected String randomAtrIdForVbucket(CoreTransactionAttemptContextClassic self, Integer vbucketIdForDoc, int numAtrs) {
            ...
            return hooks.beforeStagedReplace.apply(this, id) // test hook
                    ...
                    .flatMap(updatedDoc -> {
                        CoreTransactionGetResult out = createTransactionGetResult(operationId, collection, id, contentToStage,
                                contentOfBody, updatedDoc.cas(), documentMetadata, OperationTypes.REPLACE.asString(), crc32OfGet);
    ...
    private byte[] createDocumentMetadata(OperationTypes opType,
                                          String operationId,
                                          Optional<DocumentMetadata> documentMetadata) {

        ObjectNode op = Mapper.createObjectNode();
        op.put("type", opType.asString());
...
//    }
    ...
    @Stability.Internal
    @Override
    public CoreTransactionResult transactionEnd(@Nullable Throwable err, boolean singleQueryTransactionMode) {
        boolean unstagingComplete = state == AttemptState.COMPLETED;
        return transactionEnd(err, singleQueryTransactionMode, unstagingComplete);
    }
