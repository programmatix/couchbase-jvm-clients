 ...
 */
@Stability.Internal
public class TestTransactionAttemptContextFactory extends TransactionAttemptContextFactory {

    private final CoreTransactionAttemptContextHooks hooks;

    public TestTransactionAttemptContextFactory(CoreTransactionAttemptContextHooks hooks) {
        this.hooks = hooks;
    }
