...
public class AnalyticsResultHttp extends AnalyticsResult {
   ...
   */
  public AnalyticsResultHttp(final AnalyticsChunkHeader header, final List<AnalyticsChunkRow> rows,
  ...
  public AnalyticsMetaData metaData() {
    return AnalyticsMetaDataHttp.from(header, trailer);
  }
